...
class EasyRegex {
     ...
     */
    strongPasswordValidator(pass = String) {
     ...
     */
    IPv4Validator(IP = String) {
        if (typeof IP !== "string")
            throw new TypeError("IP has to be a string.");
     ...
     * @example URL_Validator("https://www.google.com") // Output: true
     */
    URL_Validator(URL = String) {
  ...
  */
    phoneNumberValidator(number = String) {
